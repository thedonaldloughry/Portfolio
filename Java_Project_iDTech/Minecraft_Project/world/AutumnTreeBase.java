...
public class AutumnTreeBase extends Block implements IPlantable
{
    protected AutumnTreeBase(Material p_i45395_1_)
    {
        super(p_i45395_1_);
    ...
    /**
     * is the block grass, dirt or farm land
     */
    protected boolean canPlaceBlockOn(Block p_149854_1_)
    {
        return p_149854_1_ == BlockRegistry.autumnGrass || p_149854_1_ == BlockRegistry.autumnDirt;
    }
    ...
    public EnumPlantType getPlantType(IBlockAccess world, int x, int y, int z)
    {
        ...
        if (this == BlockRegistry.autumnTreeSapling)        return Plains;      
        return Plains;
    }
