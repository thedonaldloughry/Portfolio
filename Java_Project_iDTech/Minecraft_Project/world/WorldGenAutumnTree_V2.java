...
public class WorldGenAutumnTree_V2 extends WorldGenAbstractTree // made the function generate abstract tree structures...
{
    public WorldGenAutumnTree_V2(boolean p_i45461_1_)
    {
        super(p_i45461_1_);
    }
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (j2 = 0; j2 < l; ++j2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, k3, k2, l1, BlockRegistry.autumnWood, 1);
                            this.setBlockAndNotifyAdequately(par1World, k3 + 1, k2, l1, BlockRegistry.autumnWood, 1);
                            this.setBlockAndNotifyAdequately(par1World, k3, k2, l1 + 1, BlockRegistry.autumnWood, 1);
                            this.setBlockAndNotifyAdequately(par1World, k3 + 1, k2, l1 + 1, BlockRegistry.autumnWood, 1);
                            i2 = k2;
                        }
                    }
                    ...
                    for (j2 = -1; j2 <= 2; ++j2)
                    {
                        for (k2 = -1; k2 <= 2; ++k2)
                        {
                            if ((j2 < 0 || j2 > 1 || k2 < 0 || k2 > 1) && par2Random.nextInt(3) <= 0)
                            {
                                ...
                                for (l2 = 0; l2 < l3; ++l2)
                                {
                                    this.setBlockAndNotifyAdequately(par1World, par3 + j2, i2 - l2 - 1, par5 + k2, BlockRegistry.autumnWood, 1);
                                }
    ...
    private void func_150526_a(World p_150526_1_, int p_150526_2_, int p_150526_3_, int p_150526_4_)
    {
        ...
        {
            this.setBlockAndNotifyAdequately(p_150526_1_, p_150526_2_, p_150526_3_, p_150526_4_, BlockRegistry.autumnLeaves, 1);
        }
    }
