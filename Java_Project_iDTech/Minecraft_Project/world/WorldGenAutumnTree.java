...
public class WorldGenAutumnTree extends WorldGenAbstractTree
{
    ...
    public WorldGenAutumnTree(boolean par1)
    {
        this(par1, (2 + rand.nextInt(5)) * 2, 0, 0, false);
    }
     ...
     */
    public WorldGenAutumnTree(boolean par1, int minTreeHeight, int metaWood, int metaLeaves, boolean canVinesGrow)
    {
        super(par1);
    ...
    {
    	//LogHelper.debug("[Alca] generate:CherryWorldGenTrees.java");
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockAutumnTreeSapling)BlockRegistry.autumnTreeSapling);
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (i2 = par3 - l1; i2 <= par3 + l1; ++i2)
                        {
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(par1World, i2, k1, k2, BlockRegistry.autumnLeaves, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, BlockRegistry.autumnWood, this.metaWood);
    ...
    {
    	//LogHelper.debug("[Alca] growVines:CherryWorldGenTrees.java");
