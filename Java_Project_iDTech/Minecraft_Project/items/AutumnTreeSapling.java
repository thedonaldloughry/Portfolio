...
public class AutumnTreeSapling extends AutumnTreeBase implements IGrowable
{
    public static final String[] field_149882_a = new String[] {"AutumnSapling"};
    private static final IIcon[] field_149881_b = new IIcon[field_149882_a.length];
    protected AutumnTreeSapling()
    {
        float f = 0.4F;
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
            field_149881_b[i] = p_149651_1_.registerIcon(this.getTextureName() + field_149882_a[i]);
        }*/
