...
public class ComfyChairBlock extends BlockContainer
{
	...
	public ComfyChairBlock(TileEntity tileEntity, String blockName, String texName)
	{
	...
	{
		return new TileEntityComfyChair(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityComfyChair tile = (TileEntityComfyChair) world.getTileEntity(x, y, z);
