...
public class MugBlock extends BlockContainer
{
	...
	public MugBlock(TileEntity tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	{
		return new TileEntityMug(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityMug tile = (TileEntityMug) world.getTileEntity(x, y, z);
