...
public class BookshelfBlock extends BlockContainer
{
	public TileEntityBookshelf tEntity;
	public String tName;
	public String bName;
	public int BlockID;
	public int facingAngle;
	
	public BookshelfBlock(TileEntityBookshelf tileEntityBookshelf, String blockName, String texName)
	{
		super(Material.wood);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		this.tEntity = tileEntityBookshelf;
		this.tName = texName;
		this.setBlockName(blockName);
	}

	public TileEntityBookshelf createNewTileEntity(World arg0, int arg1)
	{
		return new TileEntityBookshelf(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityBookshelf tile = (TileEntityBookshelf) world.getTileEntity(x, y, z);
