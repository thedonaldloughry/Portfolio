...
public class CouchBlock extends BlockContainer
{
	
	public TileEntityCouch tEntity;
	public String tName;
	public String bName;
	public int BlockID;
	public int facingAngle;
	
	public CouchBlock(TileEntityCouch tileEntity, String blockName, String texName)
	{
	...
	{
		return new TileEntityCouch(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityCouch tile = (TileEntityCouch) world.getTileEntity(x, y, z);
	...
	{
		this.updateBlockBounds(par1BlockAccess.getBlockMetadata(par2, par3, par4), false);
	}
