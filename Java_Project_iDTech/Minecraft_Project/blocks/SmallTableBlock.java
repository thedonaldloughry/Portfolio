...
public class SmallTableBlock extends BlockContainer
{
	...
	public SmallTableBlock(TileEntity tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	{
		return new TileEntitySmallTable(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntitySmallTable tile = (TileEntitySmallTable) world.getTileEntity(x, y, z);
