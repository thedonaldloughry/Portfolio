...
public class LampBlock extends BlockContainer
{
	...
	public LampBlock(TileEntity tileEntity, String blockName, String texName)
	{
		super(Material.wood); // it should catch on fire, after all...
		this.setCreativeTab(CreativeTabs.tabDecorations);
		this.tEntity = tileEntity;
		this.tName = texName;
		this.setBlockName(blockName);
		this.setLightLevel(1.0F);
		this.setLightOpacity(1); // let's see what this does...
	}

	public TileEntity createNewTileEntity(World arg0, int arg1)
	{
		return new TileEntityLamp(); // please work
	}
