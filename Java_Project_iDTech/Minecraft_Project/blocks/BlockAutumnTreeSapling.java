...
public class BlockAutumnTreeSapling extends BlockFlower {

	/****************************************** VARIABLES *********************************************/
	public static final String[] typesSapling = new String[] { "AutumnSapling" };
	private static final IIcon[] textures = new IIcon[typesSapling.length];

	/****************************************** CONSTRUCTOR *********************************************/
	public BlockAutumnTreeSapling() {
		super(0);
		...
		this.setBlockName("Autumn Sapling");
	...
	public void growTree(World world, int x, int y, int z, Random par1Random) {
		...
		object = new WorldGenAutumnTree_V2(true);
