...
public class PictureFrameBlock extends BlockContainer
{
	...
	public PictureFrameBlock(TileEntity tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	{
		return new TileEntityFramePicture(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityFramePicture tile = (TileEntityFramePicture) world.getTileEntity(x, y, z);
