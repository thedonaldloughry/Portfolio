...
public class LeaningLadderBlock extends BlockContainer
{
	public TileEntityLeaningLadder tEntity;
	public String tName;
	public String bName;
	public int BlockID;
	public int facingAngle;
	
	public LeaningLadderBlock(TileEntityLeaningLadder tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	public TileEntityLeaningLadder createNewTileEntity(World arg0, int arg1)
	{
		return new TileEntityLeaningLadder(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityLeaningLadder tile = (TileEntityLeaningLadder) world.getTileEntity(x, y, z);
