...
public class StoolBlock extends BlockContainer
{
	public TileEntityStool tEntity;
	public String tName;
	public String bName;
	public int BlockID;
	public int facingAngle;
	
	public StoolBlock(TileEntityStool tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	public TileEntityStool createNewTileEntity(World arg0, int arg1)
	{
		return new TileEntityStool(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityStool tile = (TileEntityStool) world.getTileEntity(x, y, z);
