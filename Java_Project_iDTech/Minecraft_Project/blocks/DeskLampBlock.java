...
public class DeskLampBlock extends BlockContainer
{
	public TileEntityDeskLamp tEntity;
	public String tName;
	public String bName;
	public int BlockID;
	public int facingAngle;
	
	public DeskLampBlock(TileEntityDeskLamp tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	public TileEntityDeskLamp createNewTileEntity(World arg0, int arg1)
	{
		return new TileEntityDeskLamp(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityDeskLamp tile = (TileEntityDeskLamp) world.getTileEntity(x, y, z);
