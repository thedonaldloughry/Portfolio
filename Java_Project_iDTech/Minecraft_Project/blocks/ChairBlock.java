...
{
	public TileEntityChair tEntity;
	public String tName;
	public String bName;
	public int BlockID;
	public int facingAngle;
	
	public ChairBlock(TileEntityChair tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	public TileEntityChair createNewTileEntity(World arg0, int arg1)
	{
		return new TileEntityChair(); // please work
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemStack)
	{
		...
		TileEntityChair tile = (TileEntityChair) world.getTileEntity(x, y, z);
