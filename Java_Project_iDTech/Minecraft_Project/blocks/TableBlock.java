...
public class TableBlock extends BlockContainer
{
	...
	public TableBlock(TileEntity tileEntity, String blockName, String texName)
	{
		super(Material.wood);
	...
	{
		return new TileEntityTable(); // please work
	}
