...
public class RenderLamp extends TileEntitySpecialRenderer{
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntityLamp myTile = (TileEntityLamp) arg0;
	    int direction = myTile.direction;
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/ModelLamp.png"));
		GL11.glPushMatrix();
