...
import com.DonLoughry.AllOfTheEverything.entity.TileEntityLeaningLadder;
import com.DonLoughry.AllOfTheEverything.model.*;

public class RenderLeaningLadder extends TileEntitySpecialRenderer{
	
	public ModelLeaningLadder model;
	public World worldObj;
	public BlockRegistry blockReg;
	
	
	public RenderLeaningLadder()
	{
		this.model = new ModelLeaningLadder();
	}
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntityLeaningLadder myTile = (TileEntityLeaningLadder) arg0;
	    int direction = myTile.direction;
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/ModelLeaningLadder.png"));
		GL11.glPushMatrix();
