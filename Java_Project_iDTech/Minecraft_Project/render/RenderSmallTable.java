...
import com.DonLoughry.AllOfTheEverything.entity.TileEntitySmallTable;
import com.DonLoughry.AllOfTheEverything.model.*;

public class RenderSmallTable extends TileEntitySpecialRenderer{
	
	public ModelTableSmall model;
	public World worldObj;
	public BlockRegistry blockReg;
	
	
	public RenderSmallTable()
	{
		this.model = new ModelTableSmall();
	}
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntitySmallTable myTile = (TileEntitySmallTable) arg0;
	    int direction = myTile.direction;
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/ModelTableSmall.png"));
		GL11.glPushMatrix();
