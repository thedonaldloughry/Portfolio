...
import com.DonLoughry.AllOfTheEverything.entity.TileEntityComfyChair;
import com.DonLoughry.AllOfTheEverything.model.*;

public class RenderComfyChair extends TileEntitySpecialRenderer{
	
	public ModelComfyChair model;
	public World worldObj;
	public BlockRegistry blockReg;
	
	
	public RenderComfyChair()
	{
		this.model = new ModelComfyChair();
	}
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntityComfyChair myTile = (TileEntityComfyChair) arg0;
	    int direction = myTile.direction;
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/ModelComfyChair.png"));
		GL11.glPushMatrix();
