...
import com.DonLoughry.AllOfTheEverything.entity.TileEntityWallpaper;
import com.DonLoughry.AllOfTheEverything.model.*;

public class RenderWallpaper extends TileEntitySpecialRenderer{
	
	public ModelWallpaper model;
	public World worldObj;
	public BlockRegistry blockReg;
	public String texName;
	
	
	public RenderWallpaper(String wTexName)
	{
		this.model = new ModelWallpaper();
		this.texName = wTexName;
	}
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntityWallpaper myTile = (TileEntityWallpaper) arg0;
	    int direction = myTile.direction;
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/" + texName));
		GL11.glPushMatrix();
