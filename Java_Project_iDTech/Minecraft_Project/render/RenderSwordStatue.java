...
import com.DonLoughry.AllOfTheEverything.entity.TileEntitySwordStatue;
import com.DonLoughry.AllOfTheEverything.model.*;

public class RenderSwordStatue extends TileEntitySpecialRenderer{
	
	public ModelStatueSword model;
	public World worldObj;
	public BlockRegistry blockReg;
	
	
	public RenderSwordStatue()
	{
		this.model = new ModelStatueSword();
	}
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntitySwordStatue myTile = (TileEntitySwordStatue) arg0;
	    int direction = myTile.direction;
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/ModelStatueSword.png"));
		GL11.glPushMatrix();
