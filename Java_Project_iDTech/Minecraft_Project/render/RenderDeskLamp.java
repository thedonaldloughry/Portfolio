...
import com.DonLoughry.AllOfTheEverything.entity.TileEntityDeskLamp;
import com.DonLoughry.AllOfTheEverything.model.*;

public class RenderDeskLamp extends TileEntitySpecialRenderer{
	
	public ModelDeskLamp model;
	public World worldObj;
	public BlockRegistry blockReg;
	
	
	public RenderDeskLamp()
	{
		this.model = new ModelDeskLamp();
	}
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntityDeskLamp myTile = (TileEntityDeskLamp) arg0;
	    int direction = myTile.direction;
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/ModelDeskLamp.png"));
		GL11.glPushMatrix();
