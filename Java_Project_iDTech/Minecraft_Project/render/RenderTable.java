...
public class RenderTable extends TileEntitySpecialRenderer{
	...
	public RenderTable()
	{
		this.model = new ModelTableLarge();
	}
	...
	public void renderTileEntityAt(TileEntity arg0, double x, double y,
		...
		TileEntityTable myTile = (TileEntityTable) arg0;
	    int direction = myTile.direction;
	    
		GL11.glRotatef(direction, 0F, 1F, 0F);
		this.bindTexture(new ResourceLocation("donsmod:textures/entity/ModelTableLarge.png"));
		GL11.glPushMatrix();
