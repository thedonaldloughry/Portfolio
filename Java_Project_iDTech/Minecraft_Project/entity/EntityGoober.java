...
public class EntityGoober extends EntityAnimal{
	

	private double moveSpeed;

	public EntityGoober(World par1World) {
		super(par1World);
		...
		this.tasks.addTask(2, new EntityAIPanic(this, this.moveSpeed + 0.1D));
	...
	{
		return "alloftheeverything:mob.goober.say";
	}
	
	protected String getHurtSound()
	{
		return "alloftheeverything:mob.goober.hurt";
	}
	
	protected String getDeathSound()
	{
		return "alloftheeverything:mob.goober.death"; // there is no "death" sound in the cow files...
	}
	...
	public EntityAgeable createChild(EntityAgeable arg0) {
		...
		return new EntityGoober(worldObj);
	}
