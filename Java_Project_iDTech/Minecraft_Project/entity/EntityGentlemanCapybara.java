...
public class EntityGentlemanCapybara extends EntityAnimal{
	

	private double moveSpeed;

	public EntityGentlemanCapybara(World par1World) {
		super(par1World);
		...
		this.tasks.addTask(2, new EntityAIPanic(this, this.moveSpeed + 0.3D));
		this.tasks.addTask(3, new EntityAILookIdle(this));
		this.tasks.addTask(4, new EntityAIEatGrass(this));
		
		//this.tasks.addTask(4, new EntityAITempt(this, this.moveSpeed + 0.1D, Items.bone, false));	
	...
	{
		return "alloftheeverything:mob.GentlemanCapybara.say";
	}
	
	protected String getHurtSound()
	{
		return "alloftheeverything:mob.GentlemanCapybara.hurt";
	}
	
	protected String getDeathSound()
	{
		return "alloftheeverything:mob.GentlemanCapybara.death"; // there is no "death" sound in the cow files...
	}
	
	protected void playStepSound(int par1, int par2, int par3, int par4)
	{
		this.worldObj.playSoundAtEntity(this, "alloftheeverything:mob.goober.step", 0.15F, 1.0F); // eh... we'll see if this is weird.
	...
	public EntityAgeable createChild(EntityAgeable arg0) {
		...
		return new EntityGentlemanCapybara(worldObj);
	}
